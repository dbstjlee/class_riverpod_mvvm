...
/// (ref) {...} 익명 함수이며, ref 는 Riverpod 에서 제공하는 통로를 담당하는 객체 입니다.
/// ref 를 통해 프로바이더 내에서 다른 프로바이더 읽거나 라이프 사이클을 관리할 수 있다.
final postRepositoryProvider = Provider<PostRepositoryImpl>((ref){
  // ref 객체를 통해 다른 Provider 에 접근을 마음대로 할수 있다.
  final dio = ref.read(dioProvider);
  // 의존성 주입 -> dio는 provider 가 관리하고 있는 객체라  프로바이더를 통해서 가져왔다.
